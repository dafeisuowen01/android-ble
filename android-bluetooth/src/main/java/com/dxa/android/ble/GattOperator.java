...
public interface GattOperator {
     ...
     */
    BluetoothGattCharacteristic getCharacteristic(UUID serviceUUID, UUID characteristicUUID);
     ...
     * @return 返回对应UUID的BluetoothGattCharacteristic或null
     */
    BluetoothGattCharacteristic getCharacteristic(BluetoothGattService gattService, UUID characteristicUUID);
     ...
     */
    BluetoothGattDescriptor getDescriptor(BluetoothGattCharacteristic characteristic, UUID descriptorUUID);
